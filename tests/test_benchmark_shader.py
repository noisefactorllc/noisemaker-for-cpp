...
VALID_RECORD = """{
  ...
  provenance: {
    ...
    upstreamRevision:'0ed489ec46842bffba33ee2ec65a218b6dda51f5',upstreamTree:'cde1fb6e5fc82a2fd65b2f9e35a72023e738f3f6',
...
console.log(JSON.stringify({{
  agrees: assertUpstreamPinAgreement('0ed489ec46842bffba33ee2ec65a218b6dda51f5'),
  document,
}}));
"""
        result = run_node(script)
        ...
        self.assertEqual(values["document"]["detail"]["benchmark"], "0ed489ec46842bffba33ee2ec65a218b6dda51f5")
    ...
    def test_driver_describes_exact_pinned_platform_contract(self) -> None:
        ...
        self.assertEqual(description["upstreamRevision"], "0ed489ec46842bffba33ee2ec65a218b6dda51f5")
        self.assertEqual(description["upstreamTree"], "cde1fb6e5fc82a2fd65b2f9e35a72023e738f3f6")
