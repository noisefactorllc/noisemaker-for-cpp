...
_SOURCE_GLOBAL_LITERAL_INT_PROFILES = {
    ...
    #
    # NOT here, despite qualifying structurally: filter/lightLeak (terminal
    # blocker `unsupported parameter direction out`) and filter/parallax
    # (`unsupported builtin textureLod`). Both make the tree unbuildable.
