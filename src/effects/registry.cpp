...
EffectRegistry::EffectRegistry(const EffectCatalog& catalog)
  ...
  if (provenance_.schema != "noisemaker-cpp.effect-catalog-generator.v1" ||
      ...
      provenance_.generated_payload_sha256 != "37b25dc40a7476a43eba3229f31388da412fa379049ffd400b122c560b3b8990" ||
      provenance_.normalized_record_stream_sha256 != "2bd77d3b1516df1c34ff9c23896bbbea21d0f681a602a2e392ce5cbe95278521" ||
      provenance_.compatibility_sha256 != "e37de06016a2cfd52f3b26d59ea7b91c2968c7dd330a69ab02186897b490613e" ||
  ...
  if (strict_manifest && (canonical_programs_.size() != 276 || reference_passes_.size() != 344 || !scatter_.has_value()))
  ...
  if (strict_manifest && (provenance_.counts.definitions != 208 || provenance_.counts.passes != 344 || provenance_.counts.reference_program_keys != 304 ||
      provenance_.counts.backend_programs != 277 || provenance_.counts.compatible_programs != 275 || provenance_.counts.incompatible_programs != 1 ||
      provenance_.counts.missing_passes != 67 || provenance_.counts.scatter_passes != 1 || provenance_.counts.executable_definitions != 186 ||
  ...
  if (provenance_.backend_fragment_rows != 278 || provenance_.backend_unique_fragment_keys != 276 ||
      provenance_.backend_raw_exact != 277 || provenance_.backend_semantic_exact != 0)
