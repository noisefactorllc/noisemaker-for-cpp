...
async function runCompilerOracle({ cpuRoot, fixturesPath, outputPath, checkPath }) {
  ...
  const expected = new Map([
    ...
    ['src/effects/generated/upstream-snapshot.js', 'd10108c94853eaa4fcafee0fe6823675cab22893c4eb89f94718afab46145d3e']
  ])
  ...
  if (snapshot) {
    ...
    if (compatibilityHash !== 'aa79eb9c505811137a5bef5b08b12e80ae63769bd01c748730ff48a42b956580') fail('compatibility manifest sha256 mismatch')
