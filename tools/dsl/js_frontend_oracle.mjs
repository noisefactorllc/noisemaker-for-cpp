...
async function runCompilerOracle({ cpuRoot, fixturesPath, outputPath, checkPath }) {
  ...
  const EXPECTED_STREAM_SHA256 = '1eb8d0bb28cebf13ab84eac9af3cf4c3d3616654c377b0e82c811142ef3b4958'
  ...
  if (snapshot) {
    ...
    if (compatibilityHash !== 'ec076aec3cbc400a0ec34cf20318f50fe8b1a5770bdf28004f1fad6c847cba64') fail('compatibility manifest sha256 mismatch')
  ...
  function canonical(fixture) {
    try {
      ...
      const provenance = fixture.registryMode === 'catalog_records'
        ? { sourceSha256: crypto.createHash('sha256').update(Buffer.from(fixture.source, 'utf8')).digest('hex'), sourceName: fixture.sourceName ?? fixture.name, planPayloadSha256: '', kind: 'manifest', schema: 'noisemaker-cpp.effect-catalog-generator.v1', backendSchema: 'noisemaker-cpp.backend-compatibility.v1', corpusRevision: 'a024dc3a960cc44af454abc7aebce50456c194e6', generatedPayloadSha256: '24c38ccb28ba9b7c7e0bbf33885fc7da93613612df7d4af71b7989cee71e88ab', normalizedRecordStreamSha256: '6ced4d890dc665f5f3d1196286260b972ae6858ccc9d045ec94c4e81479bf996', authorityLock: compatibility.authority?.cpu_behavioral_lock ?? '', cpuRevision: compatibility.authority?.cpu_revision ?? compatibility.authority?.cpu_behavioral_lock ?? '', sourceLockSha256: compatibility.authority?.source_lock_sha256 ?? '', cpuPackageSha256: compatibility.authority?.cpu_package_sha256 ?? '', cpuPackageLockSha256: compatibility.authority?.cpu_package_lock_sha256 ?? '', cpuSourceLockSha256: compatibility.authority?.cpu_source_lock_sha256 ?? '', upstreamRevision: compatibility.authority?.upstream_revision ?? '', upstreamTree: 'a7a997dfdc807697adba008729dcdfdfcfbaf53c', upstreamPackageSha256: compatibility.authority?.upstream_package_sha256 ?? '', upstreamPackageLockSha256: compatibility.authority?.upstream_package_lock_sha256 ?? '', compatibilitySha256: 'ec076aec3cbc400a0ec34cf20318f50fe8b1a5770bdf28004f1fad6c847cba64', counts: { definitions: 205, passes: 305, referenceProgramKeys: 295, backendPrograms: 212, compatiblePrograms: 210, incompatiblePrograms: 1, missingPasses: 93, scatterPasses: 1, executableDefinitions: 166, incompleteDefinitions: 39 } }
