...
async function runCompilerOracle({ cpuRoot, fixturesPath, outputPath, checkPath }) {
  ...
  const EXPECTED_STREAM_SHA256 = '2ea126960db16f48ac4c6d5a86c2d96cbda988cb1d9c8753b4e8328614040398'
  ...
  if (snapshot) {
    ...
    if (compatibilityHash !== 'b6a764853afd95c8310eb9c0f0c9eb85dd9e0265835df3f56582e844b1ace613') fail('compatibility manifest sha256 mismatch')
  ...
  function canonical(fixture) {
    try {
      ...
      const provenance = fixture.registryMode === 'catalog_records'
        ? { sourceSha256: crypto.createHash('sha256').update(Buffer.from(fixture.source, 'utf8')).digest('hex'), sourceName: fixture.sourceName ?? fixture.name, planPayloadSha256: '', kind: 'manifest', schema: 'noisemaker-cpp.effect-catalog-generator.v1', backendSchema: 'noisemaker-cpp.backend-compatibility.v1', corpusRevision: 'a024dc3a960cc44af454abc7aebce50456c194e6', generatedPayloadSha256: '7df157b1b992ca7db6d68d63f928042eb4073c9dbf891ecf4729fe00976f0e67', normalizedRecordStreamSha256: '0f603fa04e4a479b513affe58251101aeacf122de46d521698dfc54c95fd02af', authorityLock: compatibility.authority?.cpu_behavioral_lock ?? '', cpuRevision: compatibility.authority?.cpu_revision ?? compatibility.authority?.cpu_behavioral_lock ?? '', sourceLockSha256: compatibility.authority?.source_lock_sha256 ?? '', cpuPackageSha256: compatibility.authority?.cpu_package_sha256 ?? '', cpuPackageLockSha256: compatibility.authority?.cpu_package_lock_sha256 ?? '', cpuSourceLockSha256: compatibility.authority?.cpu_source_lock_sha256 ?? '', upstreamRevision: compatibility.authority?.upstream_revision ?? '', upstreamTree: 'cde1fb6e5fc82a2fd65b2f9e35a72023e738f3f6', upstreamPackageSha256: compatibility.authority?.upstream_package_sha256 ?? '', upstreamPackageLockSha256: compatibility.authority?.upstream_package_lock_sha256 ?? '', compatibilitySha256: 'b6a764853afd95c8310eb9c0f0c9eb85dd9e0265835df3f56582e844b1ace613', counts: { definitions: 205, passes: 305, referenceProgramKeys: 295, backendPrograms: 212, compatiblePrograms: 210, incompatiblePrograms: 1, missingPasses: 93, scatterPasses: 1, executableDefinitions: 166, incompleteDefinitions: 39 } }
