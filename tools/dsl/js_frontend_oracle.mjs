...
async function runCompilerOracle({ cpuRoot, fixturesPath, outputPath, checkPath }) {
  ...
  const EXPECTED_STREAM_SHA256 = '2f8abde1cb1362455391637825539293ff4969d47351c16d1d9de495f56d2e8e'
  ...
  if (snapshot) {
    ...
    if (compatibilityHash !== '9c42fee5ba34c5e5703aee7067c1392d17ccc256cf6c31c3c2f5b3590b5c49ea') fail('compatibility manifest sha256 mismatch')
